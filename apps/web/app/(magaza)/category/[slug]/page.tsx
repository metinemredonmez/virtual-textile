...
import { sorguyuOku, type AramaParametreleri } from '../../products/_liste/liste-sorgusu';
import { UrunListesi } from '../../products/_liste/urun-listesi';
import { kategoriAgaci, kategoriBul } from '@/lib/kategori';

/**
 * KATEGORİ LİSTESİ — `/products` ile AYNI liste bileşeni, kategori sabitlenmiş.
 *
 ...
 *    ÖLÇÜLDÜ: `/category/yok-boyle` HTTP **200** + `NEXT_HTTP_ERROR_FALLBACK;404`
  ...
  return (
    <div>
      <nav aria-label="İçerik haritası" className="mb-4 text-sm text-metin-soluk">
        <Link href="/category" className="hover:text-metin hover:underline">
          Kategoriler
        </Link>
