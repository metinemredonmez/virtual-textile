...
export function UrunGalerisi({ gorseller, baslik }: UrunGalerisiProps): React.ReactElement {
  ...
  return (
    <div className="flex flex-col gap-3">
      <div className="relative aspect-urun w-full overflow-hidden rounded-lg bg-urun-zemin">
          ...
          {sirali.map((gorsel) => {
            ...
            return (
              <button
                ...
                className={cn(
                  'relative aspect-urun w-16 shrink-0 overflow-hidden rounded-md bg-urun-zemin',
