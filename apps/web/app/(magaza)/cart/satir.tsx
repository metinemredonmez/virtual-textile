...
export function Satir({
  ...
  return (
    <li className="flex gap-4 py-4">
      <Link href={`/product/${kalem.productSlug}`} className="shrink-0">
        <div className="relative aspect-urun w-20 overflow-hidden rounded-md bg-urun-zemin">
      ...
      <div className="flex min-w-0 flex-1 flex-col gap-1">
        <div className="flex items-start justify-between gap-4">
          <div className="min-w-0">
            <Link href={`/product/${kalem.productSlug}`} className="block">
