...
import type { ApiFailure } from '@vt/contracts';
 ...
 *
 * ⚠️ Alan hataları `fieldErrorMap` üzerinden Türkçeleştirilir: `zodBody` pipe'ı
...
export function AdresFormu({
  ...
  const alanHatalari = React.useMemo(
    () => (hata ? sonParcayaIndir(fieldErrorMap(hata.fields)) : {}),
    [hata],
  );
