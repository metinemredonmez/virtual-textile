...
import { bodyProfileSchema, type BodyProfileInput, type SizeChartWire } from '@vt/contracts';
  ...
  function gonder(event: React.FormEvent): void {
    ...
    if (!sonuc.success) {
      ...
      for (const issue of sonuc.error.issues) {
        ...
        // Zod'un İngilizce varsayılanları ortak eşlemeden Türkçeye çevrilir.
        harita[yol] = fieldMessage({ path: yol, message: issue.message, rule: issue.code });
      }
