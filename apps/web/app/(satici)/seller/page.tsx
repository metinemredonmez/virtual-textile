...
import { stokDurumu } from './products/_lib/durum';
        ...
        rakamlar={[
          bekleyenler.tamam
            ? {
                ...
                href: '/seller/orders?durum=AWAITING_APPROVAL',
              }
          ...
          moderasyondakiler.tamam
            ? {
                ...
                href: '/seller/products?durum=PENDING_REVIEW',
              }
