...
export default async function PayoutPage({
  ...
  try {
    const sonuc = await hesapFetch<unknown, '/admin/payouts'>('/admin/payouts', '/admin/payout', {
      query: {
        limit: SAYFA_BOYU,
  ...
  return (
    <section className="flex flex-col gap-6">
      ...
      <ImlecSayfalama
        ilkSayfaHref={baglanti('/admin/payout', { durum: seciliDurum })}
        sonrakiHref={
          nextCursor !== null && talepler.length > 0
            ? baglanti('/admin/payout', { durum: seciliDurum, cursor: nextCursor })
            : null
        }
