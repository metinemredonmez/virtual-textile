 ...
 *    Rapor ekranları ayrı: `/yonetim/raporlar` ve `/yonetim/raporlar/ai`.
 *
 ...
 *    kabuktaki `/yonetim/komisyon` şeridi `text-lg` + `uppercase text-xs`
 ...
 *    ekran (`/yonetim/payout`) YAZILMIŞ ve sol menüde dururken. Yöneticinin
      ...
      <OzetSeridi
        rakamlar={[
          ozetHucresi('Bekleyen satıcı başvurusu', basvurular, (veri) => ({
            ...
            href: '/yonetim/saticilar?durum=PENDING',
          })),
          ...
          ozetHucresi('Bekleyen para çekme talebi', payoutlar, (veri) => ({
            ...
            */
            ...
            //    listeyi bulamaz.
            href: '/yonetim/payout?durum=REQUESTED',
          })),
